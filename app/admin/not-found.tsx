      ...
      <div className="max-w-md w-full mx-auto text-center px-6">
        <div className="mb-8">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">
            ⚙️ Admin section not available
          </h2>
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            The admin page you're looking for doesn't exist. Check the URL or return to the dashboard.
          </p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Need assistance? <Link href="/admin" className="text-primary hover:underline">Return to Admin Dashboard</Link>
          </p>
        </div>
      </div>
    </div>

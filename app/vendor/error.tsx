      ...
      <div className="max-w-md w-full mx-auto text-center px-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            An error occurred in the vendor dashboard. Please try refreshing or return to the main dashboard.
          </p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Still having issues? <Link href="/vendor" className="text-primary hover:underline">Return to dashboard</Link>
          </p>
        </div>
      </div>
    </div>

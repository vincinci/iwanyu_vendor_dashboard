-- ===============================================
-- MINIMAL DATABASE SETUP - COPY & PASTE THIS
-- ===============================================
-- Go to: https://supabase.com/dashboard/project/tviewbuthckejhlogwns/sql
...
-- 13. CREATE ORDER NUMBER SEQUENCE AND FUNCTION
...
-- 14. CREATE USER REGISTRATION FUNCTION
...
-- SETUP COMPLETE!
-- ===============================================
-- Copy this entire code, paste into Supabase SQL Editor, and click RUN
-- Your vendor and admin dashboards will work perfectly after this!
-- ===============================================
